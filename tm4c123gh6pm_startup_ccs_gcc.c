...
// Systick interrupt sets pendSV bit = 1. pendSV interrupt is LOWEST PRIORITY
// so it does not interfere with the original interrupt or others.
// When pendSV interrupt is to be serviced it triggers CONTEXT SWITCH!!!
// So there is a context switch shortly after every systick interrupt.
